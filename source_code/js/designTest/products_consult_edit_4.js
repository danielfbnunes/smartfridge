...
function GetDynamicTextBox(element, quant) {
    return '<td class="col-xs-4" style="width:32.5%" id="productName">' + element + '</td>' +
        ...
        '<td class="col-xs-2" style="text-align:center; width:17.5%" ><button type="button" class="btn btn-custom2 btn-sm remove"><i class="glyphicon glyphicon-remove-sign"></i></button></td>'
}